...
const Contact = () => {
  ...
  return (
    <section className="contact-section" id="sosialmedia">
        ...
        <div className="contact-info-cont">
          ...
          <div className="contact-info">
            ...
            <p className="wow fadeInUp">
              Ikuti sosial media saya juga
            </p>
            <ul className="contact-social wow fadeInUp">
              <li>
                <a href="https://www.instagram.com/rendiichtiar.js">
                  <i className="fab fa-instagram" />
                </a>
              </li>
              <li>
                <a href="https://discord.gg/99QFwREGut">
                  <i className="fab fa-discord" />
                </a>
              </li>
              <li>
                <a href="https://facebook.com/rendiichtiar">
